...
//       <div className="text-xs font-mono font-semibold text-center break-all px-1">{String(data.label)}</div>
...
//   useEffect(() => {
//     const initialNodes = automaton.states.map((state: string) => ({
//       id: state,
//       type: 'automatonNode',
//       data: {
//         label: state === '∅' ? '∅' : `{${state}}`,
...
//     setNodes(layoutedNodes as XYNode[]);
//     setEdges(layoutedEdges as XYEdge[]);
